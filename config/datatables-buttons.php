...
return [
    ...
    'parameters'    => [
        'dom'   =>
            "<'d-flex flex-column'" .
            "<'d-flex flex-column flex-md-row justify-content-between align-items-start mt-2'<l><f>><rt>" .
            "<'d-flex flex-column flex-md-row justify-content-between mt-2'<'mr-auto mb-2'i><'mb-2'p>>>",
        'order' => [[0, 'desc']],
        'buttons' => [
            'excel',
            'csv',
