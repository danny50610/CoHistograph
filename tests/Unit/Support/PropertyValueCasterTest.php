...
class PropertyValueCasterTest extends TestCase
{
    ...
    #[Test]
    public function from_storage_converts_month_day_to_carbon_immutable(): void
    {
        $result = $this->caster->fromStorage('02-29', PropertyType::MonthDay);
        ...
        $this->assertSame('02-29', $this->caster->formatForDisplay($result, PropertyType::MonthDay));
    }
