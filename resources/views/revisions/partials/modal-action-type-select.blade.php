<div class="row g-3">
    {{-- Vertex 操作 --}}
    <div class="col-12">
        <div class="fw-semibold small mb-2">Vertex 操作</div>
        <div class="d-flex flex-column gap-2">
            <button type="button" class="btn btn-outline-dark text-start"
                ...
                <div class="small">在指定 VertexType 下建立一個新 Vertex</div>
            </button>
            <button type="button" class="btn btn-outline-dark text-start"
                    onclick="revisionSelectActionType('delete_vertex')">
                <div class="fw-semibold">刪除 Vertex</div>
                <div class="small">刪除一個既有 Vertex</div>
            </button>
        </div>
    </div>
